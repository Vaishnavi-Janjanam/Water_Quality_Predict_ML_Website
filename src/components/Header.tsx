        ...
        <div className="text-center space-y-6">
          ...
          <div className="flex items-center justify-center gap-4">
            <div className="relative">
              ...
              <Droplets className="absolute -top-1 -right-1 h-6 w-6 text-accent animate-bounce" />
            </div>
            ...
            <div className="relative">
              ...
              <BarChart3 className="absolute -top-1 -right-1 h-6 w-6 text-primary animate-bounce" />
            </div>
          </div>
